...
export const metadata: Metadata = {
  title: 'Weddings',
  description:
    'Cinematic wedding photography and film — full-day coverage, candid moments, and highlight films.',
};
        ...
        <section className="bg-[hsl(30_15%_6%)] pb-12 pt-32 sm:pt-40">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            ...
            <p className="mt-5 max-w-xl text-base text-white/60">
              The biggest day, captured frame by frame — from the first look to the
              last dance, and every quiet moment in between.
            </p>
          </div>
        </section>
        <Portfolio />
