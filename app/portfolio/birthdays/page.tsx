...
export const metadata: Metadata = {
  title: 'Birthdays',
  description:
    'Bright, joyful birthday photography — from first birthdays to milestone celebrations.',
};
        ...
        <section className="bg-[hsl(30_15%_6%)] pb-12 pt-32 sm:pt-40">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            ...
            <p className="mt-5 max-w-xl text-base text-white/60">
              Every candle, every laugh, every messy slice of cake — captured bright
              and joyful so the celebration lives on.
            </p>
          </div>
        </section>
        <Portfolio />
